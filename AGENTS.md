...
pnpm run frontend:typecheck       # TypeScript
...
# Dev
pnpm run tauri:dev                # Launch desktop app with hot reload
make dev-sitl                    # Start bridge + launch app

# Android (requires Android SDK + NDK)
pnpm run android:dev              # Launch on Android emulator/device
...
- The `gen/android/` directory is generated by `pnpm tauri android init` — the AndroidManifest.xml permissions block is manually maintained
