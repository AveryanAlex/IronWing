...
export const appShellTestIds = {
  ...
  replayReadonlyBanner: "app-shell-replay-readonly-banner",
  ...
  mainViewport: "app-shell-main-viewport",
  vehiclePanelRail: "app-shell-vehicle-panel-rail",
  operatorWorkspace: "app-shell-operator-workspace",
  ...
  parameterReviewReplayReadonly: "app-shell-parameter-review-replay-readonly",
