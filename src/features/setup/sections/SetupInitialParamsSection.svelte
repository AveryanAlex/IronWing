...
import { Alert, ActionRow, Button, Card, Checkbox, Eyebrow, Field, HelperText, Input, NativeSelect } from "../../../components/ui";
...
let chemistryOptions = $derived(BATTERY_CHEMISTRIES.map((chemistry, index) => ({ value: String(index), label: chemistry.label })));
