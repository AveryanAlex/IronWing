...
import { Badge, ParameterBooleanSwitch, RebootRequiredBadge, Select, StagedBadge } from "../../../components/ui";
import { parameterWorkspaceTestIds } from "../parameter-workspace-test-ids";
import ParamDenseNumberInput from "./ParamDenseNumberInput.svelte";
...
$effect(() => {
  ...
  draft = props.row.stagedValueText ?? props.row.valueText;
