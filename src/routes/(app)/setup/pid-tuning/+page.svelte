...
let section = $derived(setupRouteSection(view, "pid_tuning"));
...
const QUADPLANE_GROUP_DEFINITIONS: ReadonlyArray<{
...
}> = [
  {
    ...
    description:
      "QuadPlane hover tuning stays bound to the Q_A_* family and never falls back to fixed-wing servo cards.",
    names: [
      "Q_A_RAT_RLL_P",
      "Q_A_RAT_RLL_I",
      "Q_A_RAT_RLL_D",
