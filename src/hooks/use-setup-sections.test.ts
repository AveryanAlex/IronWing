...
describe("computeOverallProgress", () => {
    ...
    it("tracks the expanded staged-confirmable sections", () => {
        expect(TRACKABLE_SECTIONS.has("serial_ports")).toBe(true);
        expect(TRACKABLE_SECTIONS.has("rtl_return")).toBe(true);
        expect(TRACKABLE_SECTIONS.has("geofence")).toBe(true);
        expect(TRACKABLE_SECTIONS.has("initial_params")).toBe(true);
    });
