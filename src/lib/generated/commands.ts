...
import type { SourceKind, McpSettings, McpSettingsResult } from "./ironwing";
...
export type InvokeCommandMap = {
  ...
  mcp_settings_read: CommandSpec<NoArgs, McpSettingsResult>;
  mcp_settings_write: CommandSpec<{ settings: McpSettings }, McpSettingsResult>;
  mcp_token_generate: CommandSpec<NoArgs, string>;
...
export const COMMAND_PLATFORM_SUPPORT = {
  ...
  mcp_settings_read: ["native","web","remote","mock"] as const,
  mcp_settings_write: ["native","web","remote","mock"] as const,
  mcp_token_generate: ["native","remote","mock"] as const,
