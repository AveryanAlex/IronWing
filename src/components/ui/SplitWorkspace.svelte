...
<div
  class="grid h-full min-h-0 grid-cols-[minmax(var(--split-primary-min),var(--split-primary-max))_minmax(280px,1fr)] gap-[var(--workspace-gutter-split)] max-[1024px]:grid-cols-1"
  data-testid={testId}
