...
<section class="logs-card" data-testid="logs-replay-panel">
  <div class="logs-card__header">
    ...
    <span class="logs-pill" data-tone={playbackTone} data-testid="logs-playback-status-pill">
      {playbackStatus}
    </span>
  </div>
  ...
  <div class="logs-replay__status-row">
    ...
    <div class="logs-replay__actions">
      <button class="logs-button logs-button--ghost" data-testid="logs-prepare-playback" disabled={!canPreparePlayback} onclick={onPrepare} type="button">
        Prepare
      </button>
      <button class="logs-button" data-testid="logs-play-button" disabled={!canPlayPlayback} onclick={onPlay} type="button">
        {playbackStatus === "playing" ? "Replay active" : "Play"}
      </button>
      <button class="logs-button logs-button--ghost" data-testid="logs-pause-button" disabled={!replaySessionActive || playbackStatus === "paused"} onclick={onPause} type="button">
        Pause
      </button>
      <button class="logs-button logs-button--danger" data-testid="logs-stop-button" disabled={!replaySessionActive} onclick={onStop} type="button">
        Stop
      </button>
    </div>
  </div>
  ...
  <div class="logs-timeline">
    ...
    <div class="logs-timeline__footer">
      ...
      <div class="logs-timeline__handoff">
        <button class="logs-button logs-button--ghost" data-testid="logs-map-path-button" disabled={selectedEntry == null} onclick={onSendPathToMap} type="button">
          Send path to map
        </button>
        <button class="logs-button logs-button--ghost" data-testid="logs-map-marker-button" disabled={selectedEntry == null || !replaySessionActive} onclick={onSendReplayMarker} type="button">
          Send replay marker
        </button>
      </div>
    </div>
