                ...
                <div className="rounded-lg border border-border bg-bg-tertiary/50 p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <ScaledParamInput
                            ...
                            params={params}
                            label="Return Speed"
                            description="Ground speed during return. 0 = use default waypoint speed."
                            displayUnit="m/s"
                            factor={100}
                            min={0}
                            step={0.5}
                        ...
                        <ParamNumberInput
                            ...
                            description="Distance from home at which the vehicle considers the return complete."
                            unit="m"
                            min={0}
                            step={0.5}
                        />
