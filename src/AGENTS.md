...
- `src/` is the shipped SvelteKit runtime rooted at `src/routes/+layout.svelte` and the `(app)` route group.
...
- Bootstrap and shell: `routes/+layout.svelte`, `routes/(app)/*`, `app/shell/*`
