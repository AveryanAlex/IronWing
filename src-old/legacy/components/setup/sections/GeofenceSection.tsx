    ...
    return (
        <div className="flex flex-col gap-3 p-4">
            <SetupSectionIntro
                ...
                description={
                    rover
                        ? "Configure virtual boundaries to keep the vehicle within a safe operating area. Rover supports circle radius and margin fences without altitude limits."
                        : "Configure virtual boundaries to keep the vehicle within a safe operating area. Supports altitude limits, circle radius, and polygon fences."
                }
