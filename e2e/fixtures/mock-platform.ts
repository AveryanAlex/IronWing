...
export const setupWorkspaceSelectors = {
    ...
    navigationSection: `[data-testid="${setupWorkspaceTestIds.navigationSection}"]`,
    navigationSummary: `[data-testid="${setupWorkspaceTestIds.navigationSummary}"]`,
    navigationLiveState: `[data-testid="${setupWorkspaceTestIds.navigationLiveState}"]`,
    navigationLiveDetail: `[data-testid="${setupWorkspaceTestIds.navigationLiveDetail}"]`,
    navigationPortState: `[data-testid="${setupWorkspaceTestIds.navigationPortState}"]`,
    navigationDocsLink: `[data-testid="${setupWorkspaceTestIds.navigationDocsLink}"]`,
...
export const missionWorkspaceSelectors = {
    ...
    homeDocsLink: `[data-testid="${missionWorkspaceTestIds.homeDocsLink}"]`,
...
export async function expectRuntimeDiagnostics(page: Page): Promise<void> {
    ...
    await expect(page.locator(runtimeSelectors.entrypoint)).toContainText("src/routes/(app)/+layout.svelte");
}
